# -*- coding: utf-8 -*-
"""Segmentation Final_Project_edited.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1hqDt2Wzi7GSkxpLRICHhB8UYidyl3kDi
"""
...
# ------ Import data ------
df_subscribers = pd.read_csv('subscribers_2.csv')
...
corr_df = df_subscribers.drop(columns=['subid','tier'])
...
corr_df = corr_df.dropna(subset=['weekly_consumption_hour','age','revenue'])
...
df_cluster.to_csv('clustering_output_edited.csv')
